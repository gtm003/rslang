      ...
      <div className="minigames__wrapper">
        {lives > 0 && gameWords.length !== 0 && !isWelcomeScreen ?
          <>
            ...
            <div className="audio-challenge__word" ref={word} onClick={() => playAudio(translationWord.audio)}>
              <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0)">
                  <path d="M2.05813 45.3298C0.920743 45.3298 0 46.2506 0 47.3868V57.6751C0 58.8125 0.920743 59.7332 2.05813 59.7332C3.19434 59.7332 4.11509 58.8125 4.11509 57.6751V47.3868C4.11509 46.2506 3.19434 45.3298 2.05813 45.3298V45.3298Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M12.3535 36.9041C11.2173 36.9041 10.2954 37.826 10.2954 38.9622V67.4511C10.2954 68.5885 11.2173 69.5092 12.3535 69.5092C13.4898 69.5092 14.4117 68.5885 14.4117 67.4511V38.9622C14.4117 37.826 13.4898 36.9041 12.3535 36.9041Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M22.6348 22.6951C21.4986 22.6951 20.5767 23.6158 20.5767 24.752V82.3679C20.5767 83.5042 21.4986 84.4261 22.6348 84.4261C23.771 84.4261 24.6929 83.5042 24.6929 82.3679V24.752C24.6929 23.6158 23.771 22.6951 22.6348 22.6951Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M32.9234 32.9832C31.7872 32.9832 30.8652 33.9039 30.8652 35.0413V70.0213C30.8652 71.1575 31.7872 72.0794 32.9234 72.0794C34.0596 72.0794 34.9815 71.1575 34.9815 70.0213V35.0413C34.9815 33.9039 34.0596 32.9832 32.9234 32.9832Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M63.9891 28.0015C62.8529 28.0015 61.9321 28.9222 61.9321 30.0596V76.3546C61.9321 77.4908 62.8529 78.4116 63.9891 78.4116C65.1253 78.4116 66.0472 77.4908 66.0472 76.3546V30.0596C66.0472 28.9222 65.1253 28.0015 63.9891 28.0015Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M84.3658 30.9253C83.2295 30.9253 82.3076 31.8472 82.3076 32.9834V74.1366C82.3076 75.274 83.2295 76.1948 84.3658 76.1948C85.502 76.1948 86.4227 75.274 86.4227 74.1366V32.9834C86.4227 31.8472 85.502 30.9253 84.3658 30.9253Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M94.6543 41.2136C93.5181 41.2136 92.5962 42.1355 92.5962 43.2718V63.8484C92.5962 64.9846 93.5181 65.9065 94.6543 65.9065C95.7905 65.9065 96.7113 64.9846 96.7113 63.8484V43.2718C96.7113 42.1355 95.7905 41.2136 94.6543 41.2136Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M74.0777 14.4634C72.9403 14.4634 72.0195 15.3853 72.0195 16.5215V90.5978C72.0195 91.7351 72.9403 92.6559 74.0777 92.6559C75.2139 92.6559 76.1346 91.7351 76.1346 90.5978V16.5215C76.1346 15.3853 75.2139 14.4634 74.0777 14.4634V14.4634Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M43.2113 47.3867C42.075 47.3867 41.1543 48.3086 41.1543 49.4448V57.675C41.1543 58.8124 42.075 59.7331 43.2113 59.7331C44.3475 59.7331 45.2694 58.8124 45.2694 57.675V49.4448C45.2694 48.3086 44.3475 47.3867 43.2113 47.3867Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M104.942 46.6982C103.806 46.6982 102.884 47.619 102.884 48.7552V57.6589C102.884 58.7951 103.806 59.717 104.942 59.717C106.079 59.717 107.001 58.7951 107.001 57.6589V48.7552C107.001 47.619 106.079 46.6982 104.942 46.6982Z" fill="#E3E3E3" fillOpacity="0.38" />
                  <path d="M53.3062 42.7751C52.1688 42.7751 51.248 43.6959 51.248 44.8321V61.5821C51.248 62.7183 52.1688 63.6402 53.3062 63.6402C54.4424 63.6402 55.3631 62.7183 55.3631 61.5821V44.8321C55.3631 43.6959 54.4424 42.7751 53.3062 42.7751Z" fill="#E3E3E3" fillOpacity="0.38" />
                </g>
                <defs>
                  <clipPath id="clip0">
            ...
            <button className="btn audio-challenge__button">
              {!isAnswered ?
                "Не знаю" :
