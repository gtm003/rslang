...
const HeaderRedux: React.FC<HeaderProps> = ({ isLoginOpen, isSignUpOpen, isAuth, user, toggleLoginOpen, signUpUser, loginUser }) => {
  ...
  const clazz = isAuth ? 'main-nav__logo--auth' : '';
      ...
      <nav className="header__site-nav main-nav">
        <ul className="main-nav__list">
          <li className="main-nav__item">
            <Link to={'/'} >
              <svg className={`main-nav__logo ${clazz}`} width="149" height="77" viewBox="0 0 149 77" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M56.2077 41.0676L71.0216 55.8814L75.0555 51.8475L65.1344 41.9264L84.2421 22.8187L79.3494 17.9259L56.2077 41.0676Z"/>
              </svg>
            </Link>
          </li>
