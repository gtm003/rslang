...
const HeaderRedux: React.FC<HeaderProps> = ({isLoginOpen, isSignUpOpen, isGameOpen, isAuth, user, toggleLoginOpen, signUpUser, loginUser}) => {
    ...
    <>
      ...
      <header className="header">
        ...
        <div className="header__right-column-wrapper right-column-wrapper">
          ...
          {
            user.userId ?
              <button disabled={isLoginOpen || isSignUpOpen} className="btn right-column-wrapper__login-btn-green"
                      onClick={() => {
              ...
              :
              <button disabled={isLoginOpen || isSignUpOpen} className="btn right-column-wrapper__login-btn-yellow"
                      onClick={() => toggleLoginOpen(true)}>
                Войти
              </button>
          }
