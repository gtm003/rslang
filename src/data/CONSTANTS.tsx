...
const menuLinks: string[] = ['Главная', 'Учебник', 'Мини-игры', 'Словарь', 'Статистика', 'О команде'];
...
const titleGames: GamesProps[] = [
  {
    ...
    iconUrl: '/rslang/images/games/constructor.svg',
    imgUrl: '/rslang/images/games/constructor.png',
    description: 'Учит быстро переводить с английского на ваш родной язык.',
  }, {
    id: 'savannah',
    name: 'Саванна',
    iconUrl: '/rslang/images/games/savannah.svg',
    imgUrl: '/rslang/images/games/savannah.png',
    description: 'Учит быстро переводить с английского на ваш родной язык.',
  }, {
    id: 'audio',
    name: 'Аудиовызов',
    iconUrl: '/rslang/images/games/audio.svg',
    imgUrl: '/rslang/images/games/audio.png',
    description: 'Учит быстро переводить с английского на ваш родной язык.',
  }, {
    id: 'sprint',
    name: 'Спринт',
    iconUrl: '/rslang/images/games/sprint.svg',
    imgUrl: '/rslang/images/games/sprint.png',
    description: 'Учит быстро переводить с английского на ваш родной язык.',
  },
]
