...
export {levelsEnglish, githubMembers, githubSrc, urlBackend, navLink, descriptionGroup, titleGroup, menuLinks,titleGames, TEAM, getDataPage, setData, DICTIONARY_TITLES, WORDS_ON_PAGE, dictionaryLinks};
